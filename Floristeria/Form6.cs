...
namespace Floristeria
{
    public partial class Form6 : Form
    {
        ...
        {
            SqlCommand agregar = new SqlCommand("insert into Proveedores values(@Nombre, @Apellido, @Telefono)", conexion);
            conexion.Open();
            ...
            try
            {
                foreach (DataGridViewRow row in dataGridViewDatos.Rows)
                {
                    ...
                    agregar.Parameters.AddWithValue("@Productos", Convert.ToString(row.Cells["ColumnProductos"].Value));
        ...
        private void btningresar_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewDatos.Rows[n].Cells[3].Value = txtproductos.Text;
        ...
        private void dataGridViewDatos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtproductos.Text = dataGridViewDatos[3, poc].Value.ToString();
        }
        ...
        private void btnactualizar_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewDatos[3, poc].Value = txtproductos.Text;
        }
